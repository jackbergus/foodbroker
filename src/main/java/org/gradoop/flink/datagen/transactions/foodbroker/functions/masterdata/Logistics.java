 ...
 */
public class Logistics extends MasterData implements Function<MasterDataSeed, Vertex> {
  /**
  ...
  public void open() {
    ...
    ee = ExecutionEnvironment.instance();
    adjectives = ee.getBroadcastVariable(FoodBrokerBroadcastNames.ADJECTIVES_BC);
    nouns = ee.getBroadcastVariable(FoodBrokerBroadcastNames.NOUNS_BC);
    cities = ee.getBroadcastVariable(FoodBrokerBroadcastNames.CITIES_BC);
    //get their sizes

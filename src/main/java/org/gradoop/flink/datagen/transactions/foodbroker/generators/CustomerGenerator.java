...
public class CustomerGenerator extends BusinessRelationGenerator {
   ...
   */
  public CustomerGenerator(FoodBrokerConfig foodBrokerConfig) {
  ...
  public StreamableIterator<Vertex> generate() {
    ...
    env.withBroadcastSet(env.fromCollection(getAdjectives()), FoodBrokerBroadcastNames.ADJECTIVES_BC)
    ...
    return env.streamAsIterator(seeds)

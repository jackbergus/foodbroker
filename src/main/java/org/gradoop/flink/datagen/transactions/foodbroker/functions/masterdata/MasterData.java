 ...
 */
public abstract class MasterData implements Function<MasterDataSeed, Vertex> {

  private ExecutionEnvironment ee = ExecutionEnvironment.instance();
  public ExecutionEnvironment getRuntimeContext() {
    return ee;
  }
   ...
   */
  public Properties createDefaultProperties(MasterDataSeed seed, String acronym) {
